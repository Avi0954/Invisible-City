    ...
    <div className="max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-12 py-8 lg:py-12 min-h-[calc(100vh-4.5rem)] font-sans text-[#1c1c18] space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-8 space-y-6">
          {/* Main Case Title Card */}
          <Card variant="container" className="shadow-xs p-6 space-y-6">
            <div className="space-y-3">
              ...
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-[#1c1c18] tracking-tight font-headline">
                {report.title}
              </h1>
              ...
              <div className="flex flex-wrap items-center gap-4 text-xs text-[#787770]">
                <div className="flex items-center space-x-1.5">
                  ...
                  <span>Reported by <strong className="text-[#1c1c18]">{report.user_name || 'Resident'}</strong></span>
                </div>
                <div className="flex items-center space-x-1.5">
            ...
            <div className="border-t border-[#d0cdc5] pt-5">
              <ReportTimeline status={report.status} verificationStatus={report.verification_status} />
            </div>

            {/* Description Section */}
            <div className="space-y-2 border-t border-[#d0cdc5] pt-5">
              <h3 className="text-xs font-bold text-[#787770] uppercase tracking-wider font-headline">Report Description</h3>
              <p className="text-sm text-[#1c1c18] leading-relaxed whitespace-pre-line font-sans">{report.description}</p>
            </div>
          </Card>

          {/* Signal Analysis Layer Card */}
          <Card variant="container" className="shadow-xs p-6 space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-xs font-bold text-[#787770] uppercase tracking-wider flex items-center space-x-2 font-headline">
                <Sparkles className="h-4 w-4 text-[#2f685f]" />
                <span>AI Signal Analysis Layer</span>
              </h3>
        ...
        {/* Sidebar Panel (Right, lg:col-span-4) */}
        <div className="lg:col-span-4 space-y-6 lg:sticky lg:top-24">
          {/* Location Details Card */}
          <Card variant="container" className="shadow-xs p-5 space-y-3">
            <h3 className="text-xs font-bold text-[#787770] uppercase tracking-wider font-headline">Location & Coordinates</h3>
            <div className="rounded-xl border border-[#e5e2da] bg-[#fcf9f2] p-4 space-y-2 text-xs">
              <div className="flex items-start space-x-2 text-[#1c1c18]">
                ...
                <div>
                  ...
                  <div className="text-[#787770] font-mono text-[11px] pt-1">
            ...
            {duplicateData && duplicateData.duplicates.length > 0 ? (
              <div className="space-y-2">
                {duplicateData.duplicates.map((dup) => (
                  <div key={dup.id} className="rounded-xl border border-amber-300 bg-amber-50/80 p-3.5 space-y-2 text-xs">
                    <div className="flex items-center justify-between">
                      ...
                      <Link
                        ...
                        className="inline-flex items-center space-x-1 text-[#06291b] hover:underline font-bold text-[11px]"
                      >
                        <span>View Case</span>
            ...
            {relatedData && relatedData.related_reports.length > 0 ? (
              <div className="space-y-2">
                {relatedData.related_reports.map((rel) => (
                  <div key={rel.id} className="rounded-xl border border-[#e5e2da] bg-[#fcf9f2] p-3.5 space-y-2 text-xs">
                    <div className="flex items-center justify-between">
