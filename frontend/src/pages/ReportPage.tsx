...
export const ReportPage: React.FC = () => {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-8 space-y-6 font-sans text-[#1c1c18]">
      ...
      <div className="grid grid-cols-4 gap-2 text-xs font-semibold font-headline">
        <button
          type="button"
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {currentStep === 1 && (
            <div className="space-y-4 font-sans animate-in fade-in duration-200">
              <div className="flex items-center justify-between border-b border-[#e5e2da] pb-2 font-headline">
