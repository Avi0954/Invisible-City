...
export const HomePage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col w-full bg-[#fcf9f2] font-sans text-[#1c1c18]">
      {/* ==================================================
          1. HERO SECTION & CONCEPT STATEMENT
         ================================================== */}
      <section className="w-full py-16 sm:py-20 lg:py-24 border-b border-[#e5e2da]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="max-w-3xl space-y-6">
            ...
            <p className="text-base sm:text-lg text-[#484742] leading-relaxed max-w-2xl font-sans">
          ...
          {/* ==================================================
             ...
             ================================================== */}
          <div className="p-6 rounded-3xl bg-[#f1eee7] border border-[#e5e2da] shadow-xs">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-4 text-xs font-semibold text-[#1c1c18]">
              <div className="flex items-center space-x-2 bg-[#fcf9f2] p-3 rounded-xl border border-[#e5e2da]">
              ...
              <div className="col-span-2 sm:col-span-1 flex items-center space-x-2 bg-[#06291b] text-white p-3 rounded-xl">
                <span className="text-base">→</span>
      ...
      {/* ==================================================
         ...
         ================================================== */}
      <section className="w-full bg-[#f1eee7] border-b border-[#e5e2da] py-10 sm:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4 lg:gap-6">
            <Card variant="surface" className="p-6 space-y-2">
              <span className="text-xs font-bold uppercase tracking-wider text-[#787770] font-headline">
                Reports
              </span>
              <div className="text-3xl sm:text-5xl font-extrabold text-[#1c1c18] font-headline">
                {totalReportsStr}
              </div>
            ...
            <Card variant="surface" className="p-6 space-y-2">
              ...
              <div className="text-3xl sm:text-5xl font-extrabold text-amber-900 font-headline">
                {activeIssuesStr}
              </div>
            ...
            <Card variant="surface" className="p-6 space-y-2">
              ...
              <div className="text-3xl sm:text-5xl font-extrabold text-[#06291b] font-headline">
                {resolvedStr}
              </div>
      ...
      <section className="w-full py-16 sm:py-20 border-b border-[#e5e2da] bg-[#fcf9f2]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="max-w-xl space-y-2">
            <h2 className="text-2xl sm:text-4xl font-extrabold text-[#1c1c18] font-headline tracking-tight">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-5 gap-4">
            <div className="p-5 rounded-2xl bg-[#f1eee7] border border-[#e5e2da] space-y-3">
            ...
            <div className="p-5 rounded-2xl bg-[#e1f3ee] border border-[#a2d8cb] space-y-3">
            ...
            <div className="p-5 rounded-2xl bg-[#06291b] text-white space-y-3">
      ...
      <section className="w-full py-16 sm:py-20 border-b border-[#e5e2da] bg-[#f1eee7]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
            {/* Citizen Input Mock */}
            <div className="md:col-span-6 p-6 rounded-2xl bg-[#fcf9f2] border border-[#e5e2da] space-y-3">
              <div className="text-[10px] font-bold uppercase tracking-wider text-[#787770] font-headline flex items-center space-x-1.5">
                <FileText className="h-3.5 w-3.5 text-[#2f685f]" />
                <span>Citizen Input</span>
              </div>
              <p className="text-xs text-[#1c1c18] font-medium leading-relaxed italic bg-[#f1eee7] p-3.5 rounded-xl border border-[#e5e2da]">
                "Large pothole near the main road causing severe traffic slowdowns and rim damage to cars during evening rain."
              </p>
            </div>

            {/* AI Output Card */}
            <div className="md:col-span-6 p-6 rounded-2xl bg-[#06291b] text-white space-y-4 shadow-md">
              <div className="flex items-center justify-between border-b border-white/15 pb-3">
                <span className="text-[10px] font-bold uppercase tracking-wider text-[#8ac9be] font-headline flex items-center space-x-1.5">
                  <Sparkles className="h-3.5 w-3.5" />
                  <span>Structured AI Output</span>
                </span>
                <span className="text-[10px] font-mono bg-[#8ac9be]/20 text-[#8ac9be] px-2 py-0.5 rounded border border-[#8ac9be]/30">
                  94% Confidence
                </span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 text-xs">
                <div>
                  ...
                  <div className="font-bold text-white font-headline">Roads & Potholes</div>
                </div>
                <div>
                  <div className="text-[10px] text-white/60 uppercase font-headline">Severity</div>
                  <div className="font-bold text-amber-400 font-headline">High Severity</div>
                </div>
                <div>
                  <div className="text-[10px] text-white/60 uppercase font-headline">Priority Score</div>
                  <div className="font-bold text-[#8ac9be] font-mono text-base">82 / 100</div>
                </div>
                <div>
                  <div className="text-[10px] text-white/60 uppercase font-headline">Suggested Action</div>
                  <div className="font-bold text-white font-headline">Dispatch Road Crew</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="w-full py-16 sm:py-20 border-b border-[#e5e2da] bg-[#fcf9f2]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="h-80 w-full rounded-3xl overflow-hidden border border-[#e5e2da] shadow-xs relative">
            <MapContainer
      ...
      <section className="w-full py-16 sm:py-20 border-b border-[#e5e2da] bg-[#f1eee7]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 text-xs font-bold font-headline text-[#1c1c18]">
            <div className="p-4 rounded-2xl bg-[#fcf9f2] border border-[#e5e2da] flex flex-col items-center justify-center space-y-2 text-center">
              <MapPin className="h-5 w-5 text-[#2f685f]" />
              <span>Roads</span>
            </div>
            <div className="p-4 rounded-2xl bg-[#fcf9f2] border border-[#e5e2da] flex flex-col items-center justify-center space-y-2 text-center">
              <Droplets className="h-5 w-5 text-[#2f685f]" />
              <span>Water</span>
            </div>
            <div className="p-4 rounded-2xl bg-[#fcf9f2] border border-[#e5e2da] flex flex-col items-center justify-center space-y-2 text-center">
              <Zap className="h-5 w-5 text-[#2f685f]" />
              <span>Lighting</span>
            </div>
            <div className="p-4 rounded-2xl bg-[#fcf9f2] border border-[#e5e2da] flex flex-col items-center justify-center space-y-2 text-center">
              <Trash2 className="h-5 w-5 text-[#2f685f]" />
              <span>Waste</span>
            </div>
            <div className="p-4 rounded-2xl bg-[#fcf9f2] border border-[#e5e2da] flex flex-col items-center justify-center space-y-2 text-center">
      ...
      {/* ==================================================
         ...
         ================================================== */}
      <section className="w-full py-16 sm:py-24 bg-[#06291b] text-white">
        <div className="max-w-4xl mx-auto px-4 text-center space-y-6">
          ...
          <div className="pt-2">
            <Link to="/report">
              <Button size="lg" variant="accent" leftIcon={<PlusCircle className="h-5 w-5" />} rightIcon={<ArrowRight className="h-4 w-4" />}>
                Report an issue →
              </Button>
            </Link>
          </div>
