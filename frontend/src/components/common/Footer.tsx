...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="border-t border-[#2d3a33] bg-[#0c1813] py-12 text-xs text-[#a3b3aa] font-sans">
      <div className="mx-auto max-w-[1440px] px-6 sm:px-8 lg:px-12 space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand & Description */}
          <div className="space-y-3 md:col-span-2">
            <div className="flex items-center space-x-2.5">
              <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-[#2f685f] text-white">
                <Building2 className="h-4 w-4" />
              </div>
              <span className="text-base font-bold text-[#fcf9f2] tracking-tight font-headline">Invisible City</span>
            </div>
            <p className="text-[#a3b3aa] text-xs leading-relaxed max-w-sm">
              Making local civic issues easier to see, understand, and act on. Connecting community reports to support better municipal response.
            </p>
          </div>
