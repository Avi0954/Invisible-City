              ...
              <div className="flex items-center space-x-3">
                <div className="relative flex-1">
                  <input
                    ...
                    required
                  />
                  <span className="absolute right-3 top-2 text-[10px] text-slate-500">LAT</span>
                </div>
                <div className="relative flex-1">
                  <input
                    type="number"
                    ...
                    required
                  />
                  <span className="absolute right-3 top-2 text-[10px] text-slate-500">LNG</span>
                </div>
                <button
                  type="button"
                  onClick={handleGetLocation}
                  className="flex items-center space-x-1.5 rounded-xl border border-slate-700 bg-slate-800 hover:bg-slate-700 px-3 py-2 text-xs font-medium text-slate-200 transition-colors"
                >
